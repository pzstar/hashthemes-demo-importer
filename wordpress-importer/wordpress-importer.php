...
if (class_exists('WP_Importer')) {
    ...
    class WP_Import extends WP_Importer {
        ...
        var $custom_menu_metas = array('_menu_item_megamenu', '_menu_item_megamenu_col', '_menu_item_megamenu_heading', '_menu_item_category_post', '_menu_item_megamenu_template', '_menu_item_megamenu_widgetarea', '_menu_item_icon');
        ...
        function import_options() {
            ...
            <form action="<?php echo admin_url('admin.php?import=wordpress&amp;step=2'); ?>" method="post">
                ...
                <?php if (!empty($this->authors)) : ?>
                    ...
                    <p><?php _e('To make it easier for you to edit and save the imported content, you may want to reassign the author of the imported item to an existing user of this site. For example, you may want to import all the entries as <code>admin</code>s entries.', 'hashthemes-demo-importer'); ?></p>
                ...
                <?php if ($this->allow_fetch_attachments()) : ?>
                    ...
                    <p>
                        ...
                        <label for="import-attachments"><?php _e('Download and import file attachments', 'hashthemes-demo-importer'); ?></label>
                    </p>
                <?php endif; ?>
        ...
        function author_select($n, $author) {
            ...
            if ($create_users) {
                if ($this->version != '1.0') {
                    ...
                    _e('as a new user:', 'hashthemes-demo-importer');
            ...
            wp_dropdown_users(array('name' => "user_map[$n]", 'multi' => true, 'show_option_all' => __('- Select -', 'hashthemes-demo-importer')));
        ...
        function process_menu_item($item) {
            ...
            if (!$menu_slug) {
                _e('Menu item skipped due to missing menu slug', 'hashthemes-demo-importer');
                echo '<br />';
                return;
            }
